...
function update_buttons() {
  (0, _jquery2.default)('.time-button').each(function (_, bb) {
    ...
    var time = (0, _jquery2.default)(bb).data('time');
    if (time != "") {
      (0, _jquery2.default)(bb).text("Start");
    } else {
      (0, _jquery2.default)(bb).text("End");
    }
  });
}
...
function set_button(user_id, value) {
  (0, _jquery2.default)('.time-button').each(function (_, bb) {
    if (user_id == (0, _jquery2.default)(bb).data('user-id')) {
      (0, _jquery2.default)(bb).data('time', value);
    }
  });
  update_buttons();
}
...
function init_time() {
  ...
  (0, _jquery2.default)(".time-button").click(time_click);
