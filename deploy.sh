...
export PORT=5120
export MIX_ENV=prod
export GIT_PATH=/home/tasktracker2/tasktracker2
...
REL_TAR=~/tasktracker2/_build/prod/rel/tasktracker2/releases/0.0.1/tasktracker2.tar.gz
(cd ~/www/tasktracker2 && tar xzvf $REL_TAR)

crontab - <<CRONTAB
@reboot bash /home/tasktracker2/tasktracker2/start.sh
CRONTAB
